...
Due to the reasons explained in \autoref{ArchitecturalDesign:provider} the most important component of the system is the System Controller into the Provider, so this components has a half of the computational power of the system dedicated only to itself. The other components, including the other parts of the System Controller have exactly one node dedicated and as 
