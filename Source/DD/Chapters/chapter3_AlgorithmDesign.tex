...
\fbox{\begin{minipage}{0.8\textwidth}
		...
		\hspace*{0.5cm} {\color{cyan} \textit{for}} {\color{green} i} = {\color{red} 0} -> {\color{green} verticalSectors} {\color{cyan} \textit{do}}\\
		\hspace*{1.5 cm} {\color{cyan} \textit{for}} {\color{green} j} = {\color{red} 0} -> {\color{green} horizontalSectors} {\color{cyan} \textit{do}}\\
...
\fbox{\begin{minipage}{0.8\textwidth}
		...
		\hspace*{0.5cm} {\color{cyan} \textit{while}} ({\color{green} parserIt}.hasNext()) {\color{cyan} \textit{do}}\\
		\hspace*{1.5cm} {\color{green} street} = {\color{green} parserIt}.next();\\
		\hspace*{1.5cm} {\color{green} x} = {\color{green} street}.firstCoordinate().getX();\\
		\hspace*{1.5cm} {\color{green} y} = {\color{green} street}.firstCoordinate().getY();\\
		\hspace*{1.5cm} {\color{green} row} = ({\color{green} x} - WestX) / {\color{red} 1.5};\\
		\hspace*{1.5cm} {\color{green} col} = (NorthY - {\color{green} y}) / {\color{red} 1.5};\\
		\hspace*{1.5cm} {\color{cyan} \textit{if}} ( {\color{green} street}.type().equalTo(\textquoteleft V\textquoteright) \&\& checkY(y , row)) {\color{cyan} \textit{do}}\\
		\hspace*{2.5cm} {\color{green} row} = {\color{green} row} + {\color{red} 1};\\
		\hspace*{1.5cm} {\color{cyan} \textit{else if}} ( {\color{green} street}.type().equalTo(\textquoteleft H\textquoteright) \&\& checkX(x, col)) {\color{cyan} \textit{do}}\\
		\hspace*{2.5cm} {\color{green} col} = {\color{green} col} + {\color{red} 1};\\
		\hspace*{1.5cm} Map.getArea(row,col).addStreet(street);
	\end{minipage}}\\[0.5cm]
...
\fbox{\begin{minipage}{0.8\textwidth}
		...
		\hspace*{1.5cm} {\color{cyan} \textit{if}} ({\color{green} y} \textgreater ({\color{green} start} + {\color{red} 1,5} * CORRECTOR)) {\color{cyan} \textit{do}}\\
		...
		\hspace*{1.5cm} {\color{cyan} \textit{if}} ({\color{green} x} \textgreater ({\color{green} start} + {\color{red} 1,5} * CORRECTOR)) {\color{cyan} \textit{do}}\\
		\hspace*{2,5cm} {\color{cyan} \textit{return}} \textbf{true};\\
		\hspace*{1,5cm} {\color{cyan} \textit{return}} \textbf{false};\\
		\hspace*{0.5cm} \textbraceright
	\end{minipage}}\\[0.5cm]
...
\fbox{\begin{minipage}{0.8\textwidth}
		\hspace*{3cm}  {\color{cyan} \textit{forall}} Area {\color{green} a} {\color{cyan} \textit{in}} Map {\color{cyan} \textit{do}}\\
