...
\label{requirements:PersonalInformationManagement}
\begin{tabular}{lp{8cm}}
	\hline 
	Actors & Users  \\ \hline
...
\label{requirements:ZerotimeReservationMA}
\begin{tabular}{lp{8cm}}
	\hline 
...
\label{requirements:FutureReservation}
\begin{tabular}{lp{8cm}}
	\hline 
	Actors & User (or \Gls{driver}) \\ \hline
...
\label{requirements:WorkShiftsManagement}
\begin{tabular}{lp{8cm}}
	\hline 
	Actors & \Gls{driver}\\ \hline
