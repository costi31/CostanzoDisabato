...
\begin{tabular}{lp{8cm}}
	...
	Execution Flow &  \begin{enumerate}
					...
					\item The Visitor is redirected to his personal page and becomes an user or a driver.
				\end{enumerate}
	 \\ \hline
	 Postconditions & The Visitor is now an user or a driver (depends on his keys), he is logged and his capable to use all his reserved functionalities. \\ \hline
...
\begin{figure}
	...
	\caption{Sequence diagram for the zero time reservation}
\end{figure}
