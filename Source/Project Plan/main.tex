...
{\large Document version 1.1, released on \today} % Date, change the \today to a set date if you want to be precise
...
%Project Estimation
\subfile{Chapters/chapter2_Project_estimation}

% ProjectSchedule
\subfile{Chapters/chapter3_Project_Schedule}

%Project Risks
\subfile{Chapters/chapter4_project_risks}
